...
async def get_samsung_status():
    return await asyncio.to_thread(samsung_service.get_status)
...
async def volume_down():
    return await asyncio.to_thread(samsung_service.volume_down)
...
async def toggle_mute():
    return await asyncio.to_thread(samsung_service.toggle_mute)