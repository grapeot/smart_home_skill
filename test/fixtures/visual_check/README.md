...
These synthetic fixtures demonstrate the measurement-set pattern for LLM-based visual checks. They are safe to commit because they contain no real home imagery.
